...
class TestApi {
  ...
  public getTestQuestions() {
    const questions: MultipleChoiceQuestion[] = [
      { 
        ...
        answers: [
          { pts: 1, text: `Don’t dare to interrupt them` },
          { pts: 2, text: `Think it’s more important to give them some of your time; work can wait` },
          { pts: 3, text: `Listen, but with only with half an ear` },
          { pts: 4, text: `Interrupt and explain that you are really busy at the moment` },
        ]
      },
      { 
        id: 1,
        ...
        answers: [
          { pts: 1, text: `Look at your watch every two minutes` },
          { pts: 2, text: `Bubble with inner anger, but keep quiet` },
          { pts: 3, text: `Explain to other equally impatient people in the room that the doctor is always running late` },
          { pts: 4, text: `Complain in a loud voice, while tapping your foot impatiently` },
        ]
      },
      { 
        id: 2,
        ...
        answers: [
          { pts: 1, text: `Don’t dare contradict them` },
          { pts: 2, text: `Think that they are obviously right` },
          { pts: 3, text: `Defend your own point of view, tooth and nail` },
          { pts: 4, text: `Continuously interrupt your colleague` },
        ]
      },
    ]
  ...
  public getExplainers(): PersonalityTypeExplainer {
    let explainers = {}
    
    explainers[PersonalityType.MoreOfIntrovert] = {
      headline: `You are more of an introvert`,
